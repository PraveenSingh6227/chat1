...
<!--logo start-->
<a href="/" class="logo" ><img src="../img/logo/logo.png" height="50px" /></a>
<!--logo end-->
<div class="top-nav ">
  <ul class="nav pull-right top-menu">
    <!-- user login dropdown start-->
    <li class="dropdown"> <a data-toggle="dropdown" class="dropdown-toggle" href="#"> <span class="username">Hi Admin</span> <b class="caret"></b> </a>
      <ul class="dropdown-menu extended logout">
        <div class="log-arrow-up"></div>
        <li style="width:100%"><a  data-toggle="modal" href="#myModal1"><i class=" icon-suitcase"></i>Change Password</a></li>
