...
$DB_TBLName = "chatting_tbl"; // MySQL Table Name

$xls_filename = date('dmyhis').'.xls'; // Define Excel (.xls) file name
 
/***** DO NOT EDIT BELOW LINES *****/
// Create MySQL connection
$sql = "SELECT chatmessage_user as 'Customer Chat', chatmessage_vendor as 'Partner Chat' from $DB_TBLName where user_id='$_REQUEST[chatid]' order by id desc";
...
*/
echo "Customer Mobile No.: ".$_REQUEST['mobileno'];
print("\n");
echo "Customer Chat". "\t"."Partner Chat". "\t"."Date";
print("\n");
